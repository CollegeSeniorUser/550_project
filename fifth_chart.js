document.addEventListener("DOMContentLoaded", function() {
    ...
    var chartContainer = d3.select("#chartContainer4");
    var containerRect = chartContainer.node().getBoundingClientRect();
    var svgWidth4 = containerRect.width - 100;
    var svgHeight4 = containerRect.height - 20; // Adjust height to fit within container
    var margin4 = { top: 30, right: 10, bottom: 50, left: 50 };
